...
class App extends Component {
  state = {
    activeUrlImg: imagesList[0].imageUrl,
    category: 'FRUIT',
    time: 60,
    score: 0,
    isTrue: false,
  ...
  componentDidMount = () => {
    this.timerId = setInterval(this.statusTime, 1000)
  }
  ...
  render() {
    const {activeUrlImg, category, score, time, isTrue} = this.state
    const activeThumbnailImages = imagesList.filter(
      ...
      <div>
        <nav className="nav-bar">
          ...
          <ul className="nav-info">
            ...
            <li className="navbar-timer">
              <img
                src="https://assets.ccbp.in/frontend/react-js/match-game-timer-img.png"
                className="timer-img"
                alt="timer"
              />
              <p className="score-color">{time} sec</p>
            </li>
          </ul>
        </nav>
        ...
        <div className="bg-con">
          {!isTrue && (
            <div className="con">
              <div>
                <img src={activeUrlImg} alt= "match" className="thumbnail-img" />
              </div>
              <div>
                  ...
                  {tabsList.map(each => (
                    <li key={each.tabId}>
                      <button
                        type="button"
                        className={`text-btn ${
                          each.tabId === category ? 'active-btn' : ''
                        }`}
              ...
              <div className="img-con">
                <ul className="img-listCon">
                  {activeThumbnailImages.map(each => (
                    <li key={each.id} className="img-listItem">
                      <button
                        type="button"
                        className="btn"
                        onClick={() => this.imageClicked(each.thumbnailUrl)}
                      >
                        <img
          ...
          {isTrue && (
            <div className="">
              <div className="playAgain-con card2">
                <div>
                  <img
